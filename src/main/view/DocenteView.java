...
public class DocenteView {
    ...
    private void lancarNotaDocente(Docente docente) {
        try {
            ...
            main.model.Estudante estudante = estudanteControllerAtualizado.procurarEstudantePorNumeroMec(numMec);
            if (estudante == null) {
            ...
            main.model.UnidadeCurricular unidadeCurricular = unidadeCurricularControllerAtualizado.procurarUCPorNome(nomeUC);
            ...
            main.model.Avaliacao novaAvaliacao = new main.model.Avaliacao(momentoSelecionado, nota, unidadeCurricular, estudante);
    ...
    private void consultarPautaOrdenada(Docente docente) {
        try {
            ...
            List<main.model.Avaliacao> avaliacoesUC = avaliacaoController.listarAvaliacoesPorUC(ucSelecionada.getNome());
            ...
            for (main.model.Avaliacao avaliacao : avaliacoesUC) {
